...
### [1] [Sorting prolate and oblate spheroids with a diatomic gas in a magnetic field](https://arxiv.org/abs/2602.21475)
*Ruben Lier*
...
### [2] [Frequency-Dependent Magnetic modulation of deposition morphology](https://arxiv.org/abs/2602.21789)
...
### [3] [Prandtl number dependence of rotating internally heated convection](https://arxiv.org/abs/2602.21860)
...
### [4] [Large eddy simulation of turbulent swirl-stabilized flames using the front propagation formulation: impact of the resolved flame thickness](https://arxiv.org/abs/2602.21940)
*Ruochen Guo,Yunde Su,Yuewen Jiang*

Main category: physics.flu-dyn

TL;DR: The paper extends the front propagation formulation (FPF) model for LES of swirl-stabilized premixed flames, highlighting that resolved flame thickness critically affects prediction of flame dynamics, particularly the formation of trapped flame pockets causing secondary temperature peaks.


<details>
  <summary>Details</summary>
Motivation: To adapt the FPF combustion model for LES of complex swirl-stabilized turbulent premixed flames, addressing the challenge of accurately predicting flame dynamics when the flame thickness is under-resolved, and to investigate the impact of resolved flame thickness on key phenomena like flame pocket formation.

Method: Extended the FPF method to include non-adiabatic effects and coupled it with an improved sub-filter flame speed estimation to handle heat-release effects on local sub-filter turbulence. Validated the model using LES of the TECFLAM swirl-stabilized burner.

Result: Simulations agreed well with experiments, revealing that vortex stretching in the outer shear layer forms trapped flame pockets, explaining secondary temperature peaks. Predictions of this phenomenon were highly sensitive to resolved flame thickness; without proper chemical steepening modeling, flame brush thickness was overpredicted, consumption rate underestimated, and flame pockets were missed.

Conclusion: Accurate modeling of resolved flame thickness and chemical steepening effects is crucial for capturing key flame dynamics in LES of swirl-stabilized premixed flames. The extended FPF model successfully predicts complex phenomena like flame pocket formation when these aspects are properly addressed.
...
### [5] [Experimental study of turbulent thermal diffusion of inertial particles in a convective turbulence forced by oscillating grids](https://arxiv.org/abs/2602.22008)
*E. Elmakies,O. Shildkrot,N. Kleeorin,A. Levy,I. Rogachevskii*

Main category: physics.flu-dyn

TL;DR: Experimental study of turbulent thermal diffusion in convective turbulence shows inertial particles form large-scale clusters near temperature minima, with effective pumping velocity 2.5× larger for inertial particles than non-inertial ones.


<details>
  <summary>Details</summary>
Motivation: To experimentally investigate turbulent thermal diffusion of inertial solid particles in convective turbulence and validate theoretical predictions about the enhanced clustering effect compared to non-inertial particles.

Method: Laboratory experiments using convective turbulence forced by oscillating grids in air flow, measuring fluid velocity and particle distribution via PIV, temperature field via 12-thermocouple probe, comparing inertial (10 μm) and non-inertial (0.7 μm) particles.

Result: Inertial particles form large-scale clusters near mean temperature minima due to turbulent thermal diffusion, with effective pumping velocity 2.5 times larger for inertial particles than for non-inertial particles, confirming theoretical predictions.

Conclusion: Turbulent thermal diffusion causes significant particle clustering in temperature gradients, with enhanced effects for inertial particles as predicted by theory, demonstrating the importance of particle inertia in turbulent transport phenomena.
...
### [6] [Counterflow around a cylinder](https://arxiv.org/abs/2602.22022)
...
### [7] [A minimal wake-vortex model explains formation flight of flapping birds](https://arxiv.org/abs/2602.22043)
...
### [8] [Generalized Onsager-Regularized Lattice Boltzmann Method for error-free Navier-Stokes models on standard lattices](https://arxiv.org/abs/2602.21242)
*Anirudh Jonnalagadda,Walter Rocchia,Sauro Succi*

Main category: physics.comp-ph

TL;DR: Novel local correction strategy for lattice Boltzmann methods addresses Navier-Stokes modelling errors through Onsager-Regularized non-equilibrium populations, improving accuracy by 2-4 orders of magnitude and enhancing stability.


<details>
  <summary>Details</summary>
Motivation: Navier-Stokes modelling errors in first-nearest neighbor lattice Boltzmann methods need systematic correction. Current approaches have limitations in accuracy and stability, particularly for thermohydrodynamic applications requiring precise stress tensor modeling.

Method: Introduces fully local corrections through Onsager-Regularized non-equilibrium populations. Develops partially and completely corrected models for six-moment-constrained guided equilibrium on D2Q9 lattice. Partial correction addresses compatibility condition violations, while complete correction additionally fixes stress tensor modeling errors.

Result: Partial correction improves accuracy by two orders of magnitude at reference temperatures and four orders at arbitrary temperatures. Complete correction yields fully corrected exact model. Benchmarks show improved accuracy and stability compared to Lattice-BGK and uncorrected OReg-GEq schemes.

Conclusion: The proposed correction mechanism presents promising avenue for OReg-based thermohydrodynamic extensions, offering significant improvements in Navier-Stokes modeling accuracy while maintaining full locality of corrections.
...
### [9] [Efficient and Accurate Method for Separating Variant Components from Invariant Background and Component Model Fusion for Fast RFIC Design Space Exploration](https://arxiv.org/abs/2602.21335)
...
### [10] [Emergent Rate Laws for Collective Lying-Standing Transitions](https://arxiv.org/abs/2602.21747)
*Anna Werkovits,Simon B. Hollweger,Oliver T. Hofmann*

Main category: physics.comp-ph

TL;DR: The paper establishes a quantitative relationship between adsorbate geometry and collective lying-standing transition kinetics at organic-inorganic interfaces, revealing that these transitions emerge from coupled microscopic processes and cannot be predicted from single elementary steps.


<details>
  <summary>Details</summary>
Motivation: Lying-standing transitions in molecular monolayers critically influence interface properties but their collective kinetics are difficult to predict due to complex coupled processes.

Method: First-principles-based kinetic Monte Carlo simulations combined with mean-field coarse-graining strategy, applied to tetracyanoethylene on Cu(111) as a model system.

Result: Collective transition rates depend on coupled microscopic processes; geometry is an intrinsic control parameter where increasing footprint ratio between configurations yields order-of-magnitude accelerations; derived analytical expression links microscopic rate constants to geometric parameters.

Conclusion: The developed framework provides transferable design principles for engineering lying-standing transition timescales at organic-inorganic interfaces across different kinetic regimes.
...
### [11] [Phase-Dependent Excitonic Light Harvesting and Photovoltaic Limits in Monolayer Y2TeO2 MOenes](https://arxiv.org/abs/2602.22112)
